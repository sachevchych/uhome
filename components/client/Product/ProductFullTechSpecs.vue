  ...
  <div class="specs">
    ...
    <div class="d-flex" v-if="!product.specs.length">
      <span class="empty-text">
        Характеристики до цього товару поки що відсутін. Але зовсім скоро ми це виправимо, а поки ви можете зателефонувати до нас і ми проконсультуємо Вас по цьому товарові.
      </span>
    </div>
